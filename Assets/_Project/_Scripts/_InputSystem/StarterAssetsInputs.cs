...
namespace StarterAssets
{
	public class StarterAssetsInputs : MonoBehaviour
	{
		...
		private void AttackInput(bool newAttackInput)
		{
			attack = newAttackInput;;
		}
	    private void CollectInput(bool newCollectInput)
		{
			collect = newCollectInput;;
		}
	    private void DialogInput(bool newDialog)
		{
			dialog = newDialog;;
		}
	    private void ESCInput(bool newESC)
		{
			dialog = newESC;;
		}
